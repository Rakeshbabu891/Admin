...
render() {
  ...
  {this.state.orders.map(order => {
    console.log('a_id:',a_id,"order_placed",order.order_placed);
              ...
              <CardBody>
                <Table responsive>
                  ...
                  <th>Status</th>
                   ...
                   <tbody>
                   {this.state.orders.map(order => {
                     if((order.order_placed === true)&&(order.shipping_status != 'Shipped' ) && (order.shipping_status !== 'Delivered') && (order.print_status === 'Awaiting Confirmation')){
