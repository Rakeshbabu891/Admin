...
class Upload extends Component {
  ...
  componentDidMount() {
    axios
      .get(`http://localhost:5000/orders/skip/0`)
      .then((response) => {
  ...
  getData = () => {
    ...
    axios
      .get(`http://localhost:5000/orders/skip/${this.state.currentOrderNumber}`)
      .then((response) => {
        console.log("Response", response.data);
  ...
  manualPay = (order_id) => {
    var r = window.confirm("Confirm payment?");
    if (r == true) {
                          ...
                          <tr key={order._id}>
                            ...
                            )}
                            {
                              <td>
                                ...
                                >
                                  {" "}
                                  <i className={this.state.spinClass}></i> Pay
                                </button>
                              </td>
                            }
                          </tr>
